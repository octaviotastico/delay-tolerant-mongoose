...
/*
* This is a list that contains all those bundles
* that were sent but that were not received, or
* that are currently waiting for ack.
*/
const bundlesWaitingACK = {};
const bundlesWaitingInQueue = []; // TODO: Implement this for REAL_TIME_UPDATE = false.
...
delayTolerantMongoose.Model.dtCreate = async function (document) {
  // Local Update
  const localUpdate = this.create(document);
  // DTN Update.
  await AAPForwarder({
    message: {
      type: 'dtCreate',
...
delayTolerantMongoose.Model.dtInsertMany = async function (documents) {
  // Local Update.
  const localUpdate = this.insertMany(documents);
  // DTN Update.
  await AAPForwarder({
    message: {
      type: 'dtInsertMany',
...
delayTolerantMongoose.Model.dtDeleteOne = async function (filter = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.deleteOne(filter, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
      type: 'dtDeleteOne',
...
delayTolerantMongoose.Model.dtDeleteMany = async function (filter = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.deleteMany(filter, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
      type: 'dtDeleteMany',
...
delayTolerantMongoose.Model.dtUpdateOne = async function (filter = {}, update = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.updateOne(filter, update, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
      type: 'dtUpdateOne',
...
delayTolerantMongoose.Model.dtUpdateMany = async function (filter = {}, update = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.updateMany(filter, update, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
      type: 'dtUpdateMany',
...
delayTolerantMongoose.Model.dtReplaceOne = async function (filter = {}, replacement = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.replaceOne(filter, replacement, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
      type: 'dtReplaceOne',
...
delayTolerantMongoose.Model.dtFindOneAndDelete = async function (filter = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.findOneAndDelete(filter, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
...
delayTolerantMongoose.Model.dtFindOneAndRemove = async function (filter = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.findOneAndRemove(filter, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
...
delayTolerantMongoose.Model.dtFindOneAndReplace = async function (filter = {}, replacement = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.findOneAndReplace(filter, replacement, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
...
delayTolerantMongoose.Model.dtFindOneAndUpdate = async function (filter = {}, update = {}, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.findOneAndUpdate(filter, update, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
...
delayTolerantMongoose.Model.dtFindByIdAndDelete = async function (id, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.findByIdAndDelete(id, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
...
delayTolerantMongoose.Model.dtFindByIdAndRemove = async function (id, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.findByIdAndRemove(id, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
...
delayTolerantMongoose.Model.dtFindByIdAndUpdate = async function (id, update, options = {}, callback = {}) {
  // Local Update.
  const localUpdate = this.findByIdAndUpdate(id, update, options, callback);
  // DTN Update.
  await AAPForwarder({
    message: {
