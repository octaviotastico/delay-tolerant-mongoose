...
async function handleCreationMethods(actionType, localParams) {
  console.log("THIS IS", this, this.create, this["create"]);
  console.log("actionType", actionType, "localParams", localParams);
  localParams = [localParams];
  console.log("is iterable", typeof localParams[Symbol.iterator] === "function");
...
const handleUpdateMethods = async (actionType, localParams) => {
  ...
  if (isSingleUpdateMethod(actionType)) {
    ...
    const newFileHistoryArray = newDocumentVersions.map(
      async (document) =>
        await pushTohistory({
          document,
...
export const testtt3 = function () {
  console.log("This in Testtt3", this);
  console.log(this);
};

export const testtt2 = function () {
  console.log("This in Testtt2", this);
  return testtt3.bind(this)();
};
