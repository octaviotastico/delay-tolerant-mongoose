...
async function handleCreationMethods(actionType, localParams) {
  console.log("[INFO] handleCreationMethods", { actionType, localParams });
...
async function handleDeletionMethods(actionType, localParams) {
  console.log("[INFO] handleDeletionMethods", { actionType, localParams });
...
async function handleUpdateMethods(actionType, localParams) {
  console.log("[INFO] handleUpdateMethods", { actionType, localParams });
...
/**
 * @description: Handles the synchronization for the local database
 * @param {Object} localParams: Parameters used to perform the local update ([0]: filter, [1]: update, [2]: options, [3]: callback)
 */
export const handleSyncMethods = async function (actionType, localParams) {
  console.log("[INFO] handleSyncMethods", { actionType, localParams });
};
...
export const createDTNMethod = function (actionType) {
  return async function (...localParams) {
    ...
    if (isSyncMethod(actionType)) {
      return await handleSyncMethods.bind(this)(localParams);
    }
  };
};
