...
/**
 * @description Returns if the given method is a sync method or not.
 * @param {String} actionType: Name of the operation (e.g. 'create', 'deleteMany', etc...)
 * @returns {Boolean}
 * @example isSyncMethod("sync") === true, isSyncMethod("create") === false
 */
export const isSyncMethod = (actionType) => {
  return syncMethods.includes(actionType);
};
 ...
 * @returns {String} All the merge strategies.
 */
